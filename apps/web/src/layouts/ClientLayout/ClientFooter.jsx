    ...
    <footer className="bg-stone-900 text-stone-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <span className="text-xl font-bold tracking-tight text-amber-400">Forkseat</span>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li><a href="#" className="text-stone-400 hover:text-amber-400 transition-colors">Inicio</a></li>
              <li><a href="#" className="text-stone-400 hover:text-amber-400 transition-colors">Platos</a></li>
      ...
      <div className="border-t border-stone-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-stone-500">
          <p>&copy; {new Date().getFullYear()} Forkseat. Todos los derechos reservados.</p>
